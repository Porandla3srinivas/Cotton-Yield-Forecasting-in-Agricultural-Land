...
def Unet(train_data, train_target,test_data):
    ...
    Results = model.fit(train_data, train_target, validation_split=0.1, batch_size=16, epochs=2,callbacks=[earlystopper, checkpointer])
